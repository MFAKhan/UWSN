...
public class GA4_Individual {

	private final ArrayList<Integer> genes = new ArrayList<Integer>();
	private double fitness = 0;

	public GA4_Individual(final ArrayList<Integer> T) {
	...
	public double getFitness(final SimulationMap Map, final int NumNodes, final int NumAUVs, final double Speed,
		...
		if (this.fitness == -1) {
			this.fitness = GA4_Fitness.getFitness(this.genes, Map, NumNodes, NumAUVs, Speed, DistanceType,
